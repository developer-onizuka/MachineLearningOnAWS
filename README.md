...
| **Services** | [AmazonCusotmerReviewAPI.py](https://github.com/developer-onizuka/MachineLearningOnAWS/blob/main/AmazonCustomerReviewAPI.py) | [AmazonCusotmerReviewAPI.py](https://github.com/developer-onizuka/MachineLearningOnAWS/blob/main/AmazonCustomerReviewAPI.py) | Some texts | star_rating | 
```
